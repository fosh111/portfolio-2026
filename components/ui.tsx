...
export function PillLink({
  ...
  return (
    <a
      ...
      className="inline-flex h-14 items-center justify-center rounded-full border border-ink/10 bg-paper/50 px-7 font-display text-[14px] font-light text-ink shadow-[0_8px_24px_rgba(0,0,0,0.15)] backdrop-blur-[20px] backdrop-saturate-150 transition-all duration-300 dark:shadow-[0_8px_24px_rgba(0,0,0,0.35),inset_0_1px_0_rgba(255,255,255,0.1)] hover:bg-ink/10 hover:shadow-[0_10px_28px_rgba(0,0,0,0.2)] hover:font-normal"
    >
      {children}
    </a>
  );
